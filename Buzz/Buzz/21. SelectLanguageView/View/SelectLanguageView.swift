    ...
    var languageInfoView: some View {
        VStack (spacing: 0){
            ...
            CustomTextView(text: "Choose Language", textSize: 30, fontType: .POPPINS_BOLD, textColor: .white)
                .padding(10)
            CustomTextView(text: "Choose your preferred language for the app, you can adjust it later in the profile Menu.", textSize: 14, fontType: .POPPINS_REGULAR, textColor: .white,textAlignment: .center)
