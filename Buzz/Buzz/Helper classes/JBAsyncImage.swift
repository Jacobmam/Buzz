...
struct JBAsyncImage<Placeholder: View>: View {
    @StateObject private var loader: ImageLoader
    @Environment(\.imageCache) private var cache   // ✅ Access environment here
    ...
    var body: some View {
        content
            .onAppear {
                loader.setCache(cache)   // ✅ Inject cache when view appears
                loader.load()
            }
    }
